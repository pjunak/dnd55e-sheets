...
export default {
  ...
  'builder.manualScores':'Manual scores',
  'builder.pointBuyHint':'Point buy — 27 points, each base score 8–15. Species / background / feat increases are added on top.',
  'builder.pointsLeft':  '{n} pts left',
